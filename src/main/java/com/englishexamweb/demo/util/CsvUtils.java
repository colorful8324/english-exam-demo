package com.englishexamweb.demo.util;

import com.englishexamweb.demo.entities.Question;
import com.englishexamweb.demo.entities.Topic;
import com.englishexamweb.demo.exceptions.CSVException;
import com.englishexamweb.demo.services.TopicService;
        ...
        try (BufferedReader bf = new BufferedReader(new InputStreamReader(is, StandardCharsets.UTF_8));
            ...
            for (CSVRecord theCSVRecord: csvRecords) {
                Question qt = Question
                        ...
                        .topic(topicService.findTopicById(Integer.parseInt(theCSVRecord.get("TP_ID"))))
